...
contract PolyFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PolyFloki";
    string constant _symbol = "POKI";
    ...
    constructor () Auth(msg.sender) {
        ...
        _allowances[address(this)][address(router)] = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF;
    ...
    function approveMax(address spender) external returns (bool) {
        return approve(spender, 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        if(_allowances[sender][msg.sender] != 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF){
